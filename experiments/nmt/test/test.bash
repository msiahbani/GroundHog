...
SCORE="$GHOG/experiments/nmt/score.py --mode=batch --src=/SSD/siahbanim/GroudHog/lc-test/all.fr-en.cln.fr --trg=/SSD/siahbanim/GroudHog/lc-test/all.fr-en.cln.en --allow-unk"
echo "Score with RNNencdec"
$SCORE --state $GHOG/experiments/nmt/encdec_state.pkl $GHOG/experiments/nmt/encdec_model.npz >encdec_scores.txt 2>>log.txt
...
SAMPLE="$GHOG/experiments/nmt/sample.py --source=/SSD/siahbanim/GroudHog/lc-test/all.fr-en.cln.fr --beam-search --beam-size 10"
echo "Sample with RNNencdec"
$SAMPLE --trans encdec_trans.txt --state $GHOG/experiments/nmt/encdec_state.pkl $GHOG/experiments/nmt/encdec_model.npz 2>>log.txt
